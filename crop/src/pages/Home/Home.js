    ...
    <div className="App">
      <div className='createProduct'>
        <div className='product'>
          {!previewImage && <img className='notFound' src="https://images.unsplash.com/photo-1609743522653-52354461eb27?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt='notFound'/>}
        ...
        <div className='formDiv'>
          <div className='box'>
            {previewImage && <ReactCrop locked={true} ruleOfThirds={true} crop={crop} onChange={(e)=>setCrop(e)} onComplete={handleOnCropComplete}>
              <img className='image' src={URL.createObjectURL(previewImage)} alt={name} />
            </ReactCrop>}
          </div>
